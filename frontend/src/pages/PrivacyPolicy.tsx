...
const sections = [
  {
    ...
    paragraphs: [
      "This Privacy Policy explains how MyShowcase collects, uses, stores, shares, and otherwise processes personal data when you visit our website, create an account, use our publishing tools, upload content, contact support, or interact with related legal pages, onboarding flows, and hosted showcase services.",
      "This policy is intended to cover the current MyShowcase setup and the service providers we use or reasonably expect to use as part of operating the platform. It should be reviewed by qualified legal counsel before launch, particularly once your final company details, payment setup, and anti-abuse tooling are settled."
    ]
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "We may also disclose information when we believe it is necessary to investigate abuse, respond to lawful requests, enforce our terms, protect intellectual property, or protect MyShowcase, our users, or the public from harm."
    ]
  },
  {
    title: "International transfers",
    paragraphs: [
      "MyShowcase and some of our service providers may process personal data outside your country of residence, including in the United Kingdom, European Economic Area, and United States, depending on how the service is configured and which providers are used.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "You can contact us at support@myshowcase.site to request help with access, correction, deletion, or other privacy questions."
    ]
  },
  {
    title: "Children and sensitive data",
    paragraphs: [
      "MyShowcase is not intended for young children, and we do not knowingly collect personal data from children where doing so would be prohibited by law. If you believe a child has provided personal data inappropriately, contact us so we can review and take appropriate action.",
...
const PrivacyPolicy = () => {
  return (
    <LegalDocumentPage
      ...
      subtitle="How MyShowcase collects, uses, stores, and shares account, content, support, and technical data."
      sections={[...sections]}
    />
  );
};
