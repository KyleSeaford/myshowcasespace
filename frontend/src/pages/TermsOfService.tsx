...
const sections = [
  {
    ...
    paragraphs: [
      "These Terms of Service govern your access to and use of MyShowcase, including our website, hosted portfolio tools, publishing features, custom domain tools, support interactions, and related services.",
      "By creating an account, logging in, uploading content, purchasing a plan, or otherwise using MyShowcase, you agree to these Terms of Service, our Privacy Policy, and our Cookie Notice. If you do not agree, do not use the service.",
      "These Terms are intended to cover the current MyShowcase product setup. They should be reviewed by a qualified lawyer before public launch, especially once the final legal entity name, address, and governing jurisdiction are confirmed."
    ]
  },
  {
    title: "Eligibility and account registration",
    paragraphs: [
      "You must be legally able to enter into a binding contract to use MyShowcase. If you are using the service on behalf of a business, studio, school, collective, or other organisation, you confirm that you have authority to bind that organisation to these Terms.",
  ...
  },
  {
    ...
    paragraphs: [
      "You retain ownership of the content you upload or publish through MyShowcase, including text, images, project descriptions, and branding assets, subject to any rights you grant to us in these Terms.",
      ...
      "You grant MyShowcase a non-exclusive, worldwide, royalty-free licence to host, store, cache, copy, process, format, transmit, display, and distribute your content only to the extent necessary to operate, secure, back up, improve, and provide the service, including public display where you publish a site."
    ]
  },
  {
    title: "Acceptable use",
    paragraphs: [
      "You may not use MyShowcase to upload, publish, store, or distribute unlawful or abusive material. That includes pornographic, sexually explicit, exploitative, hateful, harassing, deceptive, or violent content."
    ],
    bullets: [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "If you believe content on MyShowcase infringes your copyright or other intellectual property rights, contact support@myshowcase.site with enough detail for us to identify the material, review the complaint, and contact the affected user where appropriate.",
  ...
  },
  {
    ...
    paragraphs: [
      "MyShowcase may add, remove, pause, or change features, templates, storage limits, supported file types, integrations, plan limits, domain tools, or deployment workflows at any time. We may also release beta, preview, or experimental features that are offered as-is and may be changed or withdrawn without notice.",
  ...
  },
  {
    ...
    paragraphs: [
      "Some parts of MyShowcase may be free, while others require a paid subscription or one-off payment. You agree to pay all applicable fees, taxes, and charges shown at checkout or in your account.",
  ...
  },
  {
    ...
    paragraphs: [
      "We may suspend, restrict, remove content from, or terminate your access to MyShowcase at any time if we reasonably believe you have breached these Terms, violated the law, created security or reputational risk, failed to pay charges, infringed third-party rights, or used the service in a way that may harm us, users, or the public.",
  ...
  },
  {
    ...
    paragraphs: [
      "MyShowcase and its software, branding, design elements, text, platform logic, and non-user content are owned by us or our licensors and are protected by intellectual property laws.",
  ...
  },
  {
    title: "Disclaimers",
    paragraphs: [
      "MyShowcase is provided on an as-available and as-is basis to the maximum extent permitted by law. We do not promise that the service will be uninterrupted, secure, error-free, virus-free, suitable for your particular needs, or that it will preserve or back up content without fail.",
  ...
  },
  {
    ...
    paragraphs: [
      "To the maximum extent permitted by law, MyShowcase and its affiliates, founders, contractors, and suppliers will not be liable for any indirect, incidental, special, exemplary, consequential, or punitive damages, or for any loss of profits, revenue, business, goodwill, data, or opportunity arising out of or related to the service.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Your continued use of MyShowcase after the updated Terms take effect means you accept the revised Terms. If you do not agree to the revised Terms, you must stop using the service."
    ]
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      "If you need help with these Terms, account issues, subscription cancellation, or a copyright complaint, email support@myshowcase.site."
    ]
  }
] as const;
...
const TermsOfService = () => {
  return (
    <LegalDocumentPage
      ...
      subtitle="The rules for using MyShowcase, including acceptable use, ownership, and account responsibilities."
      sections={[...sections]}
    />
  );
};
